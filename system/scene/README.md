...
| `robonix/system/scene/goal_near`               | `goal_near`      | Footprint-safe approach pose near a registered object, selected only from known traversable map cells. Pass to `navigation/navigate`. |
